...
def resolve_diagram_for_section(
    ...
    - cnc100_cooling_fan.svg: CNC-100 E101 cooling fan, ventilation, thermal flow
    - cnc100_spindle_drive.svg: CNC-100 E102 spindle drive motor, mechanical coupling, overload
    ...
    - press200_hydraulic_circuit.svg: Press-200 main ram cylinder, pump intake manifold, relief bypass valve
...
def parse_manual_text(content: str, filename: str = "manual.txt") -> List[Dict[str, Any]]:
    ...
    Automatically resolves and attaches authoritative diagram metadata.
    """
    chunks = []
...
if __name__ == "__main__":
    ...
    for i, c in enumerate(parsed_chunks[:5]):
        ...
        print(f"Diagram: {c.get('diagram_url')}")
