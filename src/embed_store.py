...
def upsert_chunks(chunks: List[Dict[str, Any]], collection_name: Optional[str] = None) -> int:
    """
...
def delete_by_machine(machine_name: str, collection_name: Optional[str] = None) -> int:
    """
...
def get_distinct_machines(collection_name: Optional[str] = None) -> List[str]:
    """
...
def get_manuals_summary(collection_name: Optional[str] = None, manuals_dir: str = "data/manuals") -> List[Dict[str, Any]]:
    """
