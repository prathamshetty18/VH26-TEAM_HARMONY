...
class TestAPIConfidenceEndpoints:
    ...
    def test_refusal_query_returns_no_confidence_score(self):
        ...
        assert resp.answer == REFUSAL_MESSAGE or "sufficient information" in resp.answer.lower() or "won't provide an unsupported answer" in resp.answer.lower() or "manuals don't cover" in resp.answer.lower()
